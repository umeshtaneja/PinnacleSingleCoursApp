...
public class VideoInfo {
    ...
    private static String[] videoTitle = {"Tier 4 Instruction","Earn Money - Value Partner", "Virtual Employee", "JobAssure Tier1", "JobAssure Tier1","JobAssure Tier1", "JobAssure Tier1", "JobAssure Tier1", "JobAssure Tier1", "JobAssure Tier1",};
